...
from global_weights_initializer_gan import GlobalWeightsInitializerGAN
from nvflare.app_common.workflows.broadcast_and_process import BroadcastAndProcess

from nvflare.app_common.app_constant import AppConstants
from nvflare.app_common.response_processors.global_weights_initializer import WeightMethod


class InitializeGlobalWeightsGAN(BroadcastAndProcess):
    def __init__(
        self,
        ...
        BroadcastAndProcess.__init__(
            self,
            processor=GlobalWeightsInitializerGAN(
