...
TRAIN_DIR = ROOT_DIR + "/maps_test/train"
VAL_DIR = ROOT_DIR + "/maps_test/val"
MODELS_DIR = ROOT_DIR + "/saved_models/he"
EVALUATION_DIR = ROOT_DIR + "/maps_test/evaluation"
RESULTS_DIR = ROOT_DIR + "/results/he"
LEARNING_RATE = 2e-4
BATCH_SIZE = 1
NUM_WORKERS = 2
IMAGE_SIZE = 256
